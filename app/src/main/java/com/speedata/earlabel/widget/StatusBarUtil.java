 ...
 * ━━━━━━神兽出没━━━━━━
 *
 * @author Reginer on 2016/8/22 16:19.
...
public class StatusBarUtil {
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    private static void setTranslucent(Activity activity, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
     ...
     * @param drawerLayout DrawerLayout
     */
    private static void setTranslucentForDrawerLayout(Activity activity, DrawerLayout drawerLayout,
                                                      int statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    private static void setTranslucentForImageViewInFragment(Activity activity, int statusBarAlpha, View needOffsetView) {
...
//            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
            activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.theme));
        } else {
            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        }
    }
